...
namespace UnityAnalyzers
{
    internal static class SR
    {
        ...
        public static readonly DiagnosticDescriptor StaticPropertyWithBodyMayReturnInvalidState = new DiagnosticDescriptor(
            ...
            messageFormat: "Static property '{0}' with getter body may return invalid static state when Domain Reloading is disabled. Consider using an auto-implemented property or ensuring the returned state is valid.",
            category: Category,
            defaultSeverity: DiagnosticSeverity.Warning,
            isEnabledByDefault: true
        );
